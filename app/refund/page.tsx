...
/**
 * Refund Policy — Drumion
 * 
 * Содержит формулировки, совместимые с требованиями Paddle:
 * • фиксированное 14-дневное окно возврата;
 * • подчёркивается, что окончательное решение принимает Paddle;
 * • убрана формулировка «No questions asked» как безусловное обещание;
 * • добавлена альтернатива подачи запроса через paddle.net;
 * • сохранены стили заголовков / текста из дизайн-системы.
 */
  ...
  return (
    <LegalPage title="Refund Policy" current="refund">
      <p>
        ...
        subscriptions. Drumion is operated by <strong>GrooveLab</strong>, an Individual Entrepreneur
        registered in Georgia. Payments are processed by Paddle, our payment provider and Merchant
        of Record.
      </p>
      ...
      <p>
        ...
        <strong>within 14&nbsp;calendar&nbsp;days of the original purchase</strong>. All refund
        requests are forwarded to and approved by Paddle at their sole discretion.
      </p>
      <p>
      ...
      <p className="mt-2">
        Alternatively, you may use Paddle’s self-service form at&nbsp;
        <a
