...
export const metadata: Metadata = {
  title: "Terms of Service — GrooveLab",
};
...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Service" current="terms">
      <p>
        These Terms of Service govern your access to and use of GrooveLab, a web application for drummers, music teachers, and students.
        By creating an account, subscribing to a paid plan, or using GrooveLab, you agree to these Terms. If you do not agree, please do not use the service.
      </p>

      <h2 className="text-white text-2xl font-semibold tracking-[-0.5px] mt-8 mb-3">1. About GrooveLab</h2>
      <p>
        GrooveLab is a subscription-based web application designed to help drummers, music teachers, and students practice, learn, organize, and improve their musical skills.
        GrooveLab may include features such as practice tools, educational content, rhythm exercises, student management tools, and other music-related functionality.
      </p>
      ...
      <p>
        ...
        For questions about these Terms or the service, you can contact us at: <a href="mailto:support@groovelab.app" className="text-[#a3e635] hover:underline">support@groovelab.app</a>
      </p>

      <h2 className="text-white text-2xl font-semibold tracking-[-0.5px] mt-8 mb-3">3. Eligibility</h2>
      <p>
        You may use GrooveLab only if you are legally able to enter into a binding agreement.
        If you use GrooveLab on behalf of a school, studio, company, or other organization, you confirm that you have authority to accept these Terms on behalf of that organization.
      </p>

      <h2 className="text-white text-2xl font-semibold tracking-[-0.5px] mt-8 mb-3">4. Account Registration</h2>
      <p>To use some or all features of GrooveLab, you may need to create an account.</p>
      <p>You agree to:</p>
      ...
      <p>
        GrooveLab offers monthly subscription plans.
      ...
      <p>Payments for GrooveLab are processed by Paddle, our authorized payment provider and Merchant of Record.</p>
      ...
      <p>
        GrooveLab does not store your full credit card details. Payment information is handled securely by Paddle.
      ...
      <p>
        ...
        To cancel, you may use the available account or billing settings, or contact us at: <a href="mailto:support@groovelab.app" className="text-[#a3e635] hover:underline">support@groovelab.app</a>
      </p>
      ...
      <p>You agree not to use GrooveLab in a way that:</p>
      <ul className="list-disc pl-5 space-y-1.5 text-[#a1a1aa]">
        <li>violates any law or regulation;</li>
        <li>infringes the rights of others;</li>
        <li>attempts to gain unauthorized access to GrooveLab, user accounts, or related systems;</li>
        <li>disrupts or damages the service;</li>
        <li>uploads malware, harmful code, or abusive content;</li>
        <li>copies, resells, sublicenses, or exploits GrooveLab without permission;</li>
      ...
      <p>
        You may be able to create, upload, store, or share content through GrooveLab, such as exercises, lesson materials, notes, student-related information, or other materials.
        You retain ownership of content you create or upload.
        By using GrooveLab, you grant us a limited permission to store, process, display, and transmit your content only as needed to provide and improve the service.
      ...
      <p>
        If you use GrooveLab as a teacher, you are responsible for how you manage student information and how you invite or communicate with students through the service.
        You agree not to upload sensitive student information unless it is necessary for your use of GrooveLab.
      ...
      <p>
        GrooveLab, including its software, design, features, branding, and content, is owned by GrooveLab or its licensors and is protected by intellectual property laws.
        These Terms do not transfer ownership of GrooveLab or its intellectual property to you.
        You may use GrooveLab only as permitted under these Terms.
      </p>

      <h2 className="text-white text-2xl font-semibold tracking-[-0.5px] mt-8 mb-3">14. Service Availability</h2>
      <p>
        We aim to keep GrooveLab available and reliable, but we do not guarantee that the service will always be uninterrupted, secure, or error-free.
      ...
      <p>
        We may add, change, or remove features from GrooveLab over time.
      ...
      <p>You may stop using GrooveLab at any time.</p>
      <p>We may suspend or terminate your access if:</p>
      <ul className="list-disc pl-5 space-y-1.5 text-[#a1a1aa]">
        <li>you violate these Terms;</li>
        <li>payment cannot be completed;</li>
        <li>your use creates risk or harm to GrooveLab, other users, or third parties;</li>
      ...
      <p>GrooveLab is provided on an &quot;as is&quot; and &quot;as available&quot; basis.</p>
      <p>
        We do not guarantee that GrooveLab will meet your specific needs, improve your musical performance, or produce any particular educational result.
      ...
      <p>To the maximum extent permitted by law, GrooveLab and its operators will not be liable for:</p>
      <ul className="list-disc pl-5 space-y-1.5 text-[#a1a1aa]">
      ...
      <p>
        To the maximum extent permitted by law, our total liability for any claim related to GrooveLab will not exceed the amount you paid for the service during the three months before the claim arose.
      ...
      <p>GrooveLab relies on third-party services, including:</p>
      <ul className="list-disc pl-5 space-y-1.5 text-[#a1a1aa]">
      ...
      <p>
        Your use of GrooveLab is also subject to our <Link href="/privacy" className="text-[#a3e635] hover:underline">Privacy Policy</Link>, which explains how we collect, use, store, and protect personal data.
      </p>
      ...
      <p>
        ...
        Your continued use of GrooveLab after the updated Terms become effective means you accept the updated Terms.
      </p>
      ...
      <p>
        If you have any questions about these Terms, please contact us at: <a href="mailto:support@groovelab.app" className="text-[#a3e635] hover:underline">support@groovelab.app</a>
      </p>
    </LegalPage>
  );
}
